<x-front-layout>
    <x-alert type="success" style="margin-left: 0" />
    <!-- Start Hero Area -->
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner" style="background-image:url('assets/images/banner/banner-1-bg.jpg')">
                        <div class="content">
                            ...
                            <p>{{ __('Space Gray Aluminum Case with') . ' ' }}
                                <br>{{ __('Black/Volt Real Sport Band') }}
                            </p>
                            <div class="button">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner custom-responsive-margin"
                        ...
                        <div class="content">
                            ...
                            <p>{{ __('Lorem ipsum dolor sit amet,') }} <br>
                                {{ __('eiusmod tempor incididunt ut labore.') }}</p>
                            <div class="button">
                                <a href="product-grids.html" class="btn">{{ __('Shop Now') }}</a>
                            </div>
                        </div>
